...
half4 motionblur_mobile( v2f i, bool noise )
{
	...
	half sample_depth0 = saturate( DecodeFloatRGBA( tex2D( _DepthTex, i.uv.xy - dir_step0 ) ) );
	half sample_depth1 = saturate( DecodeFloatRGBA( tex2D( _DepthTex, i.uv.xy + dir_step0 ) ) );
...
half4 motionblur_sm3( v2f i, bool noise )
{
	...
	half4 diffA = ref_depth.xxxx - half4( sample_depth0, sample_depth1, sample_depth2, sample_depth3 );
	half4 diffB = ref_depth.xxxx - half4( sample_depth4, sample_depth5, sample_depth6, sample_depth7 );
